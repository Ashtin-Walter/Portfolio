export const websites = [
  ...
  },
  {
    ...
    description:
      "Gras-Groen was an exciting project that involved designing a clean and professional website to match their high-quality services. The goal was to create an elegant design with seamless functionality, allowing users to easily browse their services and get in touch for quotes.",
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Muncharoo is a full-stack recipe website built with Next.js, Tailwind CSS, and a SQL backend. It allows users to browse, search, and view detailed recipes. The project is hosted on my Raspberry Pi server, with a dynamic and responsive UI designed for an engaging user experience.",
