  ...
  return (
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="w-full h-full bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            width="100%"
            height="100%"
            title="map"
          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a
                ...
                className="text-indigo-400 leading-relaxed pr-3"
              >
              ...
              <p className="leading-relaxed">+27 78 051 6010</p>
            </div>
          </div>
        </div>
        {/* <form
        ...
        >
          ...
          <p className="leading-relaxed mb-5">Let's work together.</p>
