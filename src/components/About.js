            ...
            <div className="container px-5 py-10 mx-auto text-center lg:px-40">
                <div className="flex flex-col w-full mb-20">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                        A passionate, motivated Freelance Web Developer studying towards a Bachelor's in Computer Science. I enjoy working with people to solve problems and get things done.
                    </p>
                </div>
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-600">
                        {activeTab === "stats" && (
                            <div className="p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800">
                                ...
                                <p className="text-gray-500 dark:text-gray-400"> <dl class="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8">
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">2020</dt>
                    <dd class="text-gray-500 dark:text-gray-400">Coding Since</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">10+</dt>
                    <dd class="text-gray-500 dark:text-gray-400">Repositories Published</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">111%</dt>
                    <dd class="text-gray-500 dark:text-gray-400">What I Give</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">500K+</dt>
                    <dd class="text-gray-500 dark:text-gray-400">Lines Of Code Written</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">1000+</dt>
                    <dd class="text-gray-500 dark:text-gray-400">Cups Of Coffee</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">?</dt>
                    <dd class="text-gray-500 dark:text-gray-400">Time Spent Coding For You</dd>
                </div>
            </dl></p>
                            </div>
                        )}
