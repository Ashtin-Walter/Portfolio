      ...
      <div className="container mx-auto flex px-6 md:px-10 py-16 md:py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center animate-fadeIn">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4">
            ...
            <a
              href="#skills"
              className="inline-flex items-center text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg transition-colors duration-300"
              aria-label="View Skills & Technologies"
            >
              Skills & Technologies
            </a>
            <div className="flex items-center space-x-4">
              <a href="https://github.com/AshtinJW-Dev" target="_blank" rel="noreferrer" aria-label="GitHub Profile" className="hover:scale-110 transition-transform duration-300">
                <i className="fa-brands fa-github text-2xl hover:text-green-500"></i>
              </a>
              <a href="https://www.linkedin.com/in/ashtin-walter-b60709250/" target="_blank" rel="noreferrer" aria-label="LinkedIn Profile" className="hover:scale-110 transition-transform duration-300">
                <i className="fa-brands fa-linkedin text-2xl hover:text-green-500"></i>
              </a>
            </div>
          </div>
        </div>
